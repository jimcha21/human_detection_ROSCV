...
int main(int argc, char **argv){
   ros::init(argc, argv, "raspicam_raw_node2");
   ros::NodeHandle n;
   camera_info_manager::CameraInfoManager c_info_man (n, "/guidance/rear/left_camera", "package://guidance/calibration_files/camera_params_left.yaml");

		if(!c_info_man.loadCameraInfo ("package://guidance/calibration_files/camera_params_left.yaml")){
 ...
 //  ros::Publisher image_pub = n.advertise<sensor_msgs::Image>("/guidance/left/right_camera", 1);
   ros::Publisher camera_info_pub = n.advertise<sensor_msgs::CameraInfo>("/guidance/rear/left_camera/camera_info", 1);
